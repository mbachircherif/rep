...
struct erpApp: App {
    ...
    init() {
        do {
            modelContainer = try ModelContainer(for: Product.self, Customer.self, Order.self, configurations: .init(for: Product.self, Customer.self, Order.self, isStoredInMemoryOnly: true))
        } catch {
